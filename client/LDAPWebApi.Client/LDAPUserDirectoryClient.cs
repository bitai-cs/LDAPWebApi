...
namespace Bitai.LDAPWebApi.Clients
{
    public class LDAPUserDirectoryClient<DTOType> : LDAPBaseClient<DTOType>
    {
        ...
        {
            var uri = $"{WebApiBaseUrl}/api/{ServerProfile}/{CatalogTypes.GetCatalogTypeName(UseGlobalCatalog)}/{ControllerNames.DirectoryController}/Users/{identifier}?identifierAttribute={GetOptionalEntryAttributeName(identifierAttribute)}&requiredAttributes={GetOptionalRequiredEntryAttributesName(requiredAttributes)}&requestTag={requestTag}";
